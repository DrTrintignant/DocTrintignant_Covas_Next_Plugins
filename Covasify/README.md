...
**Project lineage:** Covasify was originally created by **DocTrintignant**, restored and substantially developed by **Lag0matic** from **v3.0.0 through v4.1.1**, and is maintained and developed by **DocTrintignant** again from **v4.1.2** onward. **For the sake of simplicity, from version 4.1.2 onwards, the two development branches diverge**
